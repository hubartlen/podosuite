  ...
  try {
    ...
    const res = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        ...
        to: [to],
        subject: `Bilan podologique — Cabinet Arthur Le Neué`,
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background: #f8fafc; padding: 24px; border: 1px solid #e2e8f0; border-top: none;">
              ...
              <p style="color: #334155; font-size: 15px;">Veuillez trouver ci-joint votre bilan podologique du <strong>${new Date(bilan.date_bilan).toLocaleDateString('fr-FR', { day: '2-digit', month: 'long', year: 'numeric' })}</strong>.</p>
              <p style="color: #64748b; font-size: 13px; margin-top: 20px;">N'hésitez pas à me contacter pour toute question.</p>
