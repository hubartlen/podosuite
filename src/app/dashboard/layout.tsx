...
export default function DashboardLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display:'flex', minHeight:'100vh', background:'var(--bg)' }}>
      {/* Sidebar */}
      <aside style={{
        width:64, background:'var(--surface)', borderRight:'1px solid var(--line)',
        display:'flex', flexDirection:'column', alignItems:'center',
        padding:'16px 0', gap:6, position:'sticky', top:0, height:'100vh', flexShrink:0
      }}>
        {/* Logo */}
        <div style={{ width:38, height:38, borderRadius:11, background:'var(--accent)', color:'white', display:'grid', placeItems:'center', fontWeight:700, fontSize:16, marginBottom:14 }}>P</div>
            ...
            <Link key={href} href={href} style={{ textDecoration:'none' }}>
              <div style={{
                ...
                <span className="tip" style={{
                  ...
                  background:'#0f172a', color:'white', fontSize:12, fontWeight:500,
        ...
        <button onClick={handleLogout} style={{
          ...
          color:'var(--fg-3)', background:'transparent', border:'none', cursor:'pointer', marginBottom:8
        }}>
